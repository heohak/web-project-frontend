...
const SwipeContainer: React.FC<SwipeContainerProps> = ({ accountId }) => {
        ...
        const fetchUserDetails = async () => {
            try {
                ...
                setSwipeContainerData({
                  ...
                  study_code: accountData.study_code,
    ...
    const handleReject = () => {
        // TODO: Add logic for rejecting the profile
        console.log('Profile rejected');
    };

    const handleAccept = () => {
        // TODO: Add logic for accepting the profile
    ...
    return (
        <div className={`bg-fuchsia-50 w-1/3 h-screen overflow-y-auto overflow-hidden border border-fuchsia-300`}>
            ...
            <div className='border-fuchsia-300 border-y border-r'>
                <div className='text-fuchsia-600 text-3xl pl-4 pt-2 pb-1'>
                    <p>{swipeContainerData.name}, {swipeContainerData.age}</p>
                </div>
                <ul className='flex flex-col text-fuchsia-400 text-xl pl-4 pb-8'>
                    <p>{swipeContainerData.title}</p>
                    <p>{swipeContainerData.study_code}</p>
                </ul>
            </div>
            <div className='border-fuchsia-300 border-r'>
                <div className='text-fuchsia-400 text-xl px-4 pt-6 pb-12'>
                    <p>{swipeContainerData.content}</p>
                </div>
            </div>
